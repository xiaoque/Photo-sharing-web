...
(function($) {
   		...
   		return this.each(function() {
	    	...
	    	oOverlay.css({
   			...
   			$this.click(function(){
				...
				oImgClose.attr('src','./js/img/closebox.png').appendTo('body').hide();
				if($.fn.ifixpng) {$.ifixpng('./js/img/blank.gif');oImgClose.ifixpng('./js/img/blank.gif');}
				...
				o = $.extend(o,{oImgZoomBox:oImgZoomBox});
   				...
   				if(strTitle){
   					...
   					var tdL = oTitle.find('td:first').css({'background':'url('+'./js/img/zoom-caption-l.png)',width:'13px',height:'26px'});
   					var tdR = oTitle.find('td:last').css({'background':'url('+'./js/img/zoom-caption-r.png)',width:'13px',height:'26px'});
   					var tdC = $('.fancyTitle',oTitle).css({'background':'url('+'./js/img/zoom-caption-fill.png)',
   							'padding':'0px 20px',
   							color:'#FFF',
   							'font-size':'14px'
   							});
   					...
   					if($.fn.ifixpng){
   						tdL.ifixpng('./js/img/blank.gif');
   						tdR.ifixpng('./js/img/blank.gif');
   						tdC.ifixpng('./js/img/blank.gif');
   					}
	...
	function __displayLoading(o){
		...
		oLoading.css(__posCenter(50,50)).html('<img src="'+'./js/img/blank.gif" />').click(function(){__cancelLoading();}).appendTo('body').show();
