                ...
                <div id="pin_dinplay" class="pin">
                    <ul>
                        ...
                        <?php
            				...
            				$PIN_SQL="SELECT * FROM pin, (SELECT pin_id, COUNT( user_id ) AS count_like 
																FROM  `like_pin` GROUP BY pin_id ORDER BY count_like DESC) 
																AS popular_pin WHERE pin.pin_id = popular_pin.pin_id";
